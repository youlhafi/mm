...
/*   Updated: 2023/07/28 20:11:54 by youlhafi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_unset_env(t_pip *p, char *cmd)
{
	int		i;
	int		j;
	int		k;
...
int	ft_export_help(t_pip *p, char *new)
{
	...
	split = ft_split(new, '=');
	if (!split[0])
		return (free_double(split), ft_error("not a valid identifier", 1, new, "export"));
